package io.github.taybct.auth.security.service;
...
public interface ICustomizeUserDetailsService {
    /**
     * Locates the user based on the username. In the actual api , the search
     * may possibly be case sensitive, or case insensitive depending on how the
     * api  instance is configured. In this case, the <code>UserDetails</code>
