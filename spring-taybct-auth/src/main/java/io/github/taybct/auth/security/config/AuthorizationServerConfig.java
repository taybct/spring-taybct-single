...
import io.github.taybct.auth.exception.JsonExceptionAuthenticationEntryPoint;
import io.github.taybct.auth.security.granter.DefaultCustomizeTokenEndpointConfigurer;
...
import io.github.taybct.auth.security.granter.customize.CustomizeAuthenticatedToken;
import io.github.taybct.auth.security.granter.customize.OAuth2AuthorizationCodeRequestJTIAuthenticationConverter;
...
import io.github.taybct.auth.security.handle.deft.PropertiesClientDetailsHandle;
import io.github.taybct.auth.security.pojo.OAuth2UserDetails;
import io.github.taybct.auth.security.prop.ClientConfig;
import io.github.taybct.auth.security.service.CustomizeRegisteredClientRepository;
import io.github.taybct.auth.security.service.ICustomizeUserDetailsService;
import io.github.taybct.auth.security.util.ResponseHandler;
...
import io.github.taybct.common.enums.OAuthenticationMethodType;
