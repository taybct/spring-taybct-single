...
public interface ${baseInfo.fileName} extends IService<${tableClass.shortClassName}> {
     ...
     * @return 分页结果
     */
    <E extends ${tableClass.shortClassName}> IPage<E> page(JSONObject params, SqlPageParams sqlPageParams);
     ...
     * @return 返回列表数据
     */
    <E extends ${tableClass.shortClassName}> List<E> list(JSONObject params, SqlPageParams sqlPageParams);
