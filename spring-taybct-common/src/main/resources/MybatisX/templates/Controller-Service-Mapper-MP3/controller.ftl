...
public class ${baseInfo.fileName} implements LongKeyConvertibleController<${tableClass.shortClassName}
    ...
    @Override
    public R<? extends Collection<? extends ${tableClass.shortClassName}>> saveBatch(@Valid @NotNull @RequestBody Collection<${tableClass.shortClassName}AddDTO> domains) {
    ...
    @PutMapping
    @Override
    public R<? extends ${tableClass.shortClassName}> updateAllField(@Valid @NotNull @RequestBody ${tableClass.shortClassName}UpdateDTO domain) {
    ...
    @WebLog
    @PutMapping("batch")
    @ApiLog(title = "批量更新", description = "批量更新【${tableClass.remark}】", type = OperateType.UPDATE, isSaveRequestData = false, isSaveResultData = false)
    @Override
    public R<? extends Collection<? extends ${tableClass.shortClassName}>> updateAllFieldBatch(@Valid @NotNull @RequestBody Collection<${tableClass.shortClassName}UpdateDTO> domains) {
    ...
    @ApiLog(title = "根据 条件 批量更新数据", description = "根据 条件 批量更新【${tableClass.remark!}】", type = OperateType.UPDATE)
    @Override
    public R<?> update(@Valid @NotNull @RequestBody UpdateModel<${tableClass.shortClassName}, ${tableClass.shortClassName}UpdateDTO, ${tableClass.shortClassName}QueryBody> model) {
    ...
    @WebLog
    @DeleteMapping("/{id}")
    @ApiLog(title = "根据 id 删除记录", description = "根据 id 删除【${tableClass.remark!}】", type = OperateType.DELETE)
    @Parameters({
    ...
    @WebLog
    @DeleteMapping("batch")
    @ApiLog(title = "根据 id 批量删除记录", description = "根据 id 批量删除【${tableClass.remark!}】", type = OperateType.DELETE)
    public R<? extends ${tableClass.shortClassName}> deleteBatch(@RequestBody Set<Long> ids) {
    ...
    @Override
    public R<IPage<${tableClass.shortClassName}>> page(@RequestBody ${tableClass.shortClassName}QueryBody dto, SqlPageParams sqlPageParams) {
    ...
    @PostMapping("list")
    @Override
    public R<List<${tableClass.shortClassName}>> list(@RequestBody ${tableClass.shortClassName}QueryBody dto, SqlPageParams sqlPageParams) {
    ...
    public void downloadTemplate(HttpServletResponse response) {
        EasyExcelUtil.export("【${tableClass.remark!}】导入模板", response, ${tableClass.shortClassName}ImpDTO.class, Collections::emptyList);
    }
    ...
    @WebLog
    @PostMapping("exp")
    @ApiLog(title = "excel 导出数据", description = "excel 导出【${tableClass.remark!}】", type = OperateType.EXPORT, isSaveRequestData = false, isSaveResultData = false)
    public void exp(@RequestBody ${tableClass.shortClassName}QueryBody dto, SqlPageParams sqlPageParams, HttpServletResponse response) {
        EasyExcelUtil.export("【${tableClass.remark!}】导出数据", response, ${tableClass.shortClassName}ExpVO.class
                , () -> BeanUtil.copyToList(getBaseService().list(JSONObject.from(dto), sqlPageParams), ${tableClass.shortClassName}ExpVO.class));
    }
    ...
    public R<List<DBField>> getExportSelectedField() {
        return R.data(DBFieldUtil.generate(${tableClass.shortClassName}.class));
    }
    ...
    public void expSelectedField(@RequestBody ExportTemplate<${tableClass.shortClassName}QueryBody> template, HttpServletRequest request, HttpServletResponse response) {
