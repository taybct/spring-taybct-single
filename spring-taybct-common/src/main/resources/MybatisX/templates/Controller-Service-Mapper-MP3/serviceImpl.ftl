...
public class ${baseInfo.fileName} extends ServiceImpl<${mapperInterface.fileName}, ${tableClass.shortClassName}>
    ...
    public <UM extends ModelConvertible<? extends ${tableClass.shortClassName}>, QM extends ModelConvertible<? extends ${tableClass.shortClassName}>> boolean update(UpdateModel<${tableClass.shortClassName}, UM, QM> model) {
    ...
    @Override
    public <E extends ${tableClass.shortClassName}> List<E> list(JSONObject params, SqlPageParams sqlPageParams){
    ...
    @Override
    public <E extends ${tableClass.shortClassName}> E detail(JSONObject params) {
