...
export default class ${tableClass.shortClassName}Api {
  ...
  ): HttpReturnPage<${tableClass.shortClassName}Type.Domain> => {
    return request.post({
      url: `${r'$'}{URL}/page`,
      data: queryBody,
      params: {
   ...
   * @returns 总数
   */
  static total = (queryBody: ${tableClass.shortClassName}Type.QueryBody): HttpReturn<number> => {
    return request.post({
      url: `${r'$'}{URL}/total`,
      data: queryBody
    });
   ...
   * @returns 数据详情
   */
  static detail = (id: string): HttpReturn<${tableClass.shortClassName}Type.Domain> => {
    return request.get({
      url: `${r'$'}{URL}/${r'$'}{id}`
    });
  };
  ...
  ): HttpReturn<${tableClass.shortClassName}Type.Domain> => {
    return request.post({
      url: `${r'$'}{URL}`,
      data
    });
   ...
   * @returns 是否导入成功
   */
  static importExcel = (data: any): HttpReturn<${tableClass.shortClassName}Type.Domain[]> => {
    return request.post({
      url: `${r'$'}{URL}/imp`,
      data,
      headers: {
